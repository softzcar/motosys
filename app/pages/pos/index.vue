                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex gap-2">
                            <InputNumber :model-value="montoAbono" @input="(e) => montoAbono = e.value ?? 0" mode="decimal" :minFractionDigits="2" placeholder="Monto" class="flex-1" :disabled="!selectedMetodoId" locale="en-US" @focus="$event => ($event.target as HTMLInputElement).select()" />
