    ...
    >
      <div class="flex flex-col gap-4 pt-2">
        ...
        <div class="flex flex-col gap-2">
          ...
          <InputNumber v-model="form.monto" mode="decimal" :minFractionDigits="2" locale="en-US" @focus="$event => ($event.target as HTMLInputElement).select()" />          <div v-if="selectedMetodo && form.monto > 0" class="flex justify-between text-[11px] text-slate-500 px-1">
