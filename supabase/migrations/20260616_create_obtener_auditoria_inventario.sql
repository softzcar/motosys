-- Migration to drop and recreate the obtener_auditoria_inventario function with provider_ids
...
BEGIN
  ...
  SELECT 
    ...
    -- 5. Stock Real al final del periodo (Stock actual restando compras futuras y sumando ventas futuras)
    (
      p.stock
      -
      -- Compras futuras
    ...
    -- Proveedores de compras del producto (no anuladas)
    COALESCE(ARRAY(
